...
/**
 * Import/Export hooks for Window Management.
 *
...
export async function importData(data: unknown, version: unknown): Promise<void> {
  if (version !== null && version !== undefined && version !== exportVersion) {
    throw new Error(`unsupported Window Management export version ${String(version)} (this build understands ${exportVersion})`)
  }
